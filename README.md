...
13 chapters compare six workflows and four engine/toolchain choices, synthesize findings from 16 sources (including two YouTube transcript readings), and develop the original Signal Garden design into a concrete implementation plan.

Six copyable and downloadable templates cover repository instructions, a game review skill, a prompt-generating prompt, the Astra master prompt, targeted repair, and release.
...
- `book/sources.json`: source URLs, types, and original research notes.
